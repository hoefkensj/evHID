...
def progress(n):
	print('\x1b[3;1H\x1b[48;2;0;0;0m\x1b[128G\x1b[2K\x1b[3;1H',end='')
	# print(''.join(['\x1b[3;{X}H\x1b[48;2;{R};{G};0m  '.format(X=32+(i*2),R=0+(2*i),G=(0+8*j)) for i,j in zip(range(64,32),range(0,64,2))]),end='')
	for i in range(256):
		print('\x1b[3;{X}H\x1b[48;2;0;0;0m \x1b[48;2;{R};{G};0m   '.format(X=i // 2, R=255-(i*2) , G=i),end='')
		sleep(0.01)

	for j in range(256):
		i=256-j;sleep(0.01)
		print('\x1b[3;{X}H\x1b[48;2;{R};{G};0m   \x1b[48;2;0;0;0m '.format(X=i // 2, R=256-(i*2) , G=i),end='')


	print('\x1b[3;32H\x1b[1;48;2;0;0;0;1;38;2;255;255;255m\x1b[5mPRESS HOME KEY TO RESTART\x1b[m',end='')
